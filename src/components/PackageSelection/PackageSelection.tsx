      ...
      <div className="flex flex-wrap justify-center items-center gap-6 -mt-4">
        ...
        <div className="bg-white rounded-2xl shadow-md overflow-hidden border-2 border-[#cdcdcd] w-[320px] flex flex-col order-3 lg:order-1">
          ...
          <div className="pt-0 px-4 pb-4 flex-grow flex flex-col bg-white">
            ...
            <div className="mt-auto">
              <a
                href={getCheckoutUrl('https://secure.vnsh.com/vnshgraybogogbbgg/starter-checkout')}
                target="_self"
        ...
        >
          ...
          <div className="p-4 flex-grow flex flex-col bg-[#fff]">
            ...
            <div className="mt-auto">
              <a
                href={getCheckoutUrl('https://secure.vnsh.com/vnshgraybogogbbgg/advanced-checkout')}
                target="_self"
                rel="noopener noreferrer"
                className="block w-full"
              >
        ...
        >
          ...
          <div className="pt-0 px-4 pb-4 flex-grow flex flex-col bg-white">
            ...
            <div className="mt-auto">
              <a
                href={getCheckoutUrl('https://secure.vnsh.com/vnshgraybogogbbgg/enhanced-checkout')}
                target="_self"
                rel="noopener noreferrer"
                className="block w-full"
              >
